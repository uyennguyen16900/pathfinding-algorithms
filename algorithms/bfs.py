...
def getNeighbors(node, grid):
    ...
    for new_position in [(0, -1), (0, 1), (1, 0), (-1, 0)]:
        ...
        if node_position[0] < len(grid) and node_position[0] >= 0 and node_position[1] >= 0 and node_position[1] < len(grid) and not grid[node_position[0]][new_position[1]].isWall and not node.isVisited:
